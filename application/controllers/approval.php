...
class Approval extends CI_Controller
{
    ...
    function approval_list()
    {
        ...
        $sql_listticket = "SELECT COUNT(id_ticket) AS jml_list_ticket FROM ticket JOIN karyawan ON karyawan.nik = ticket.reported WHERE status = 2 and karyawan.id_bagian_dept = '$id_dept'";
