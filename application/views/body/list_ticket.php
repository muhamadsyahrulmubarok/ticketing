							...
							<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc">
								<thead>
									<tr>
										...
										<th data-field="idddddd" data-sortable="true">Berita Acara</th>
								...
								<tbody>
									...
									foreach ($datalist_ticket as $row) : $no++; ?>
										<tr>
											...
											<td data-field="id">
												<?php echo '<a href="' . site_url('assets/berita_acara') . '/' . $row->berita_acara . '" target="_blank"> ' . $row->berita_acara . '</a>'; ?>
											</td>
											<td data-field="id">
												<?php
												if ($row->status == 2) {
